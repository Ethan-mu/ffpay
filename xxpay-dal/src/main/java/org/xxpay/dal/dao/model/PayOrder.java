...
import org.xxpay.common.util.excel.annotation.Cell;
import org.xxpay.common.util.excel.annotation.Excel;
import org.xxpay.common.util.excel.annotation.Sheet;

import java.io.Serializable;
import java.util.Date;
@Excel(beginRow=1,dataHeader="支付订单号,商户ID,商户订单号,渠道ID,支付金额" +
        ",三位货币代码,支付状态,客户端IP,设备,商品标题,商品描述信息,特定渠道发起时额外参数" +
        ",渠道商户ID,渠道订单号,渠道支付错误码,渠道支付错误描述,扩展参数1,扩展参数2," +
        "通知地址,通知次数,最后一次通知时间,订单失效时间,订单支付成功时间,创建时间" +
        ",更新时间")
