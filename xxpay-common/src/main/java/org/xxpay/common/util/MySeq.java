...
public class MySeq {
	...
	public static String getPayOrderId(String seq_prefix_mchId) {
		return getSeqOrderId(seq_prefix_mchId,pay_seq);
	}
	...
	private static String getSeqOrderId(String seq_prefix_mchId,AtomicLong seq) {
		return String.format("%s%s%06d", seq_prefix_mchId, DateUtil.getSeqString(),  seq.getAndIncrement() % 1000000);
	}
