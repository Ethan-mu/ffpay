...
import static org.xxpay.common.constant.PayConstant.MCH_NOTIFY_STATUS_NOTIFYING;
import static org.xxpay.common.constant.PayConstant.TRANS_STATUS_INIT;
...
public class Notify4BasePay extends BaseService {
	...
	public JSONObject createNotifyInfo(PayOrder payOrder, boolean isFirst) {
		...
		if (isFirst) {
			int result = baseInsertMchNotify(payOrder.getPayOrderId(), payOrder.getMchId(), payOrder.getMchOrderNo(), PayConstant.MCH_NOTIFY_TYPE_PAY, url,MCH_NOTIFY_STATUS_NOTIFYING,TRANS_STATUS_INIT);
