...
public class PayOrderController {
    ...
    public String payOrder(@RequestBody JSONObject params) {
        ...
        //记录日志
        payLogService.createPayLog(params);
        try {
            ...
            //记录日志
            payLogService.updatePayLog(payOrder);
    ...
    private Object validateParams(JSONObject params, JSONObject payContext) {
        ...
        //TODO 校验业务系统订单号是否重复
        if (payOrderService.validateMchOrderNo(mchOrderNo) != 0) {
            errorMessage = "Duplicate mchOrderNo !!! ";
            return errorMessage;
        }

        //支付订单号生成
        payOrder.put("payOrderId", MySeq.getPayOrderId(mchId));
