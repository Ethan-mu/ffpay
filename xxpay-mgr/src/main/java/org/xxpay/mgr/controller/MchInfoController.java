...
public class MchInfoController {
    ...
    public String save(@RequestParam String params) {
        ...
        mchInfo.setState(("on".equalsIgnoreCase(po.getString("state")) ? 1 : 0));
        mchInfo.setReqKey(po.getString("reqKey"));
        mchInfo.setResKey(po.getString("resKey"));
        mchInfo.setLeaderName(po.getString("leaderName"));
        mchInfo.setLeaderPhone(po.getString("leaderPhone"));
        mchInfo.setOfficeAdress(po.getString("officeAdress"));
        String createTime = po.getString("createTime");
