...
public class GoodsOrderController {
    ...
    //static final String mchId = "1487990592";
    //zhangx 20001226
    //通付WAP 20001227
    static final String mchId = "1487990592";
    ...
    private final static String QR_PAY_URL = "http://12.0.0.1:8081/goods/qrPay.html";
    //    static final String AppID = "wx6e9638417bff1c13";
    //通付
    static final String AppID = "wx3469d88a30fafca3";

    //    static final String AppSecret = "e663ea068f3e4f952f143de1432a35c2";
    static final String AppSecret = "Sxbctv0061232gifihduijbhgkfqueqj";
    ...
    public String buy(@PathVariable("goodsId") String goodsId) {
        ...
        goodsOrder.setGoodsName("ffpay");
        goodsOrder.setAmount(1l);
        goodsOrder.setUserId("ffpay_000001");
...
//        paramMap.put("channelId", "ALIPAY_WAP");             // 支付渠道ID, WX_NATIVE,ALIPAY_WAP
        paramMap.put("channelId", "ALIPAY_QR");             // 支付渠道ID, WX_NATIVE,ALIPAY_WAP
//        paramMap.put("channelId", "ALIPAY_PC");             // 支付渠道ID, WX_NATIVE,ALIPAY_WAP
//        paramMap.put("channelId", "WX_NATIVE");
        ...
        paramMap.put("extra", "{\"productId\":\"120989823\",\"openId\":\"oIkQuwsjsA-j06E_6LebksIytaZ4\"}");  // 附加参数
...
//        goodsOrder.setChannelId("ALIPAY_WAP");
        goodsOrder.setChannelId("ALIPAY_QR");
//        goodsOrder.setChannelId("ALIPAY_PC");
...
//                channelId = "ALIPAY_PC";
    ...
    GoodsOrder createGoodsOrder(String goodsId, Long amount) {
        ...
        goodsOrder.setGoodsOrderId(goodsOrderId);
        goodsOrder.setGoodsId(goodsId);
        goodsOrder.setGoodsName("ffPAY-G_0001");
    ...
    public boolean verifySign(Map<String, Object> map) {
     ...
     public void getErWeiCode(HttpServletResponse response) throws IOException{
         String qrcodeString="www.baidu.com";
         OutputStream stream=null;
         if (!"".equals(qrcodeString)) {
             stream = response.getOutputStream();
             try {
                 MatrixToImageWriter.writeToStream(qrcodeString, stream);
             } catch (Exception e) {
                 e.printStackTrace();
             }
             stream.flush();
